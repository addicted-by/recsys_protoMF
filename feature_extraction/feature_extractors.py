...
class Embedding(FeatureExtractor):
    ...
    def __init__(self, n_objects: int, embedding_dim: int, max_norm: float = None, only_positive: bool = False, init_embedding: np.ndarray = None):
        """
        ...
        if init_embedding is not None:
            self.embedding_layer = nn.Embedding.from_pretrained(torch.from_numpy(init_embedding), freeze=False, max_norm=self.max_norm)
        else:
...
class EmbeddingW(Embedding):
    ...
    def __init__(self, n_objects: int, embedding_dim: int, max_norm: float = None, out_dimension: int = None,
                 use_bias: bool = False, init_embedding: np.ndarray = None):
        """
        ...
        """
        super().__init__(n_objects, embedding_dim, max_norm, False, init_embedding)
