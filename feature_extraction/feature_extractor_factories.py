...
class FeatureExtractorFactory:
    ...
    @staticmethod
    def create_models(ft_ext_param: dict, n_users: int, n_items: int, user_factors: np.ndarray=None, item_factors: np.ndarray=None) -> Tuple[FeatureExtractor, FeatureExtractor]:
        """
        ...
        if ft_type == 'detached':
            ...
            user_embed = FeatureExtractorFactory.create_model(ft_ext_param['user_ft_ext_param'], n_users, embedding_dim, user_factors)
            # print("FEATURE EXTRACTOR FACTORIES")
            # print(user_embed.embedding_layer.weight)
            ...
            item_embed = FeatureExtractorFactory.create_model(ft_ext_param['item_ft_ext_param'], n_items, embedding_dim, item_factors)
            ...
            user_proto.embedding_ext.embedding_layer.weight = user_embed.embedding_layer.weight
            item_proto.embedding_ext.embedding_layer.weight = item_embed.embedding_layer.weight
    ...
    @staticmethod
    def create_model(ft_ext_param: dict, n_objects: int, embedding_dim: int, embeddings: np.ndarray=None) -> FeatureExtractor:
        """
        ...
        print(f'embeddings is None: {embeddings is None}')
        if ft_type == 'embedding':
            ...
            model = EmbeddingW(n_objects, embedding_dim, max_norm, out_dimension, use_bias, embeddings)
        elif ft_type == 'prototypes':
